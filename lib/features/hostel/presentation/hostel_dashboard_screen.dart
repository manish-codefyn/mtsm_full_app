...
import '../data/hostel_dashboard_repository.dart';
...
class HostelDashboardScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final statsAsync = ref.watch(hostelDashboardStatsProvider);
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => ref.refresh(hostelDashboardStatsProvider),
          ),
        ],
      ),
      body: statsAsync.when(
        ...
        data: (data) {
          ...
          return RefreshIndicator(
            onRefresh: () async => ref.refresh(hostelDashboardStatsProvider),
